...
import { fetchDonghuaPopular, toPaginated } from "@/lib/api";

export default function DonghuaPopularPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 md:px-6">
      ...
      <InfiniteGrid
        queryKey={["donghua-popular-infinite"]}
        queryFn={(page) =>
          fetchDonghuaPopular(page).then((r) => ({
            ...toPaginated(r, page),
